...
public static class AND
{
    public static void Exercise(int index)
    {
		...
		// In either the solution is: 0010 0010

		// Exercise: Write the write AND solution on the right-hand side (0b_0000_0000)
		{
